...
def run_all_load_tests():
    ...
    TESTS = [
            ...
            ("2", "network_async_dns_external"),
            ("2", "network_async_external_retry"),
            ("2", "network_async_dns_external_retry"),
            ("3", "network_sync_external"),
            ("4", "network_sync_external"),
            ("2", "network_https_async"),
            ("2", "network_https_dns_async"),
            ("2", "network_https_async_retry"),
            ("2", "network_https_dns_async_retry"),
